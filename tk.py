...
def extract_and_replace_awakenings(url):
    ...
    if response.status_code == 200:
        ...
        print (out_of_rotation_awakenings)
        print (len(out_of_rotation_awakenings))
